...
const DateDiv = ({isDarkMode,data,localTime}) => {
    ...
    return ( 
        <section className={`flex flex-col items-center justify-center shadow-xl shadow-black  pt-4 w-96 md:w-[50rem] rounded-3xl mt-8 pb-4 md:h-[22rem] xl:w-[30rem] xl:h-[20rem] ${isDarkMode?"text-white bg-[#444444]":"text-black bg-[#D9D9D9]"}`}>
            <header className="font-bold text-3xl md:text-5xl ">
               {name}
            </header>
            <h1 className="font-bold text-6xl pt-12 md:pt-24 md:text-8xl xl:pt-24">
             {hours}:{minutes}
            </h1>
